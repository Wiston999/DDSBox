...
/**
 * A writer for the Command user type.
 */
public class CommandDataWriter extends DataWriterImpl {
    // -----------------------------------------------------------------------
    // Public Methods
    // -----------------------------------------------------------------------

    public InstanceHandle_t register_instance(Command instance_data) {
        return register_instance_untyped(instance_data);
    }
    
    
    public InstanceHandle_t register_instance_w_timestamp(Command instance_data,
    ...
    public InstanceHandle_t register_instance_w_params(Command instance_data,
    ...
    public void unregister_instance(Command instance_data,
                                     InstanceHandle_t handle) {
        unregister_instance_untyped(instance_data, handle);
    }
    
    
    public void unregister_instance_w_timestamp(Command instance_data,
    ...
    public void unregister_instance_w_params(Command instance_data,
                                             WriteParams_t params) {
    ...
    public void write(Command instance_data, InstanceHandle_t handle) {
        write_untyped(instance_data, handle);
    }
    
    
    public void write_w_timestamp(Command instance_data,
            InstanceHandle_t handle, Time_t source_timestamp) {
    ...
    public void write_w_params(Command instance_data,
                               WriteParams_t params) {
    ...
    public void dispose(Command instance_data, InstanceHandle_t instance_handle){
        dispose_untyped(instance_data, instance_handle);
    }
    
    
    public void dispose_w_timestamp(Command instance_data,
    ...
    public void dispose_w_params(Command instance_data,
                                 WriteParams_t params) {
    ...
    /*package*/ CommandDataWriter(long native_writer, DataWriterListener listener,
