...
/**
 * A sequence of Command instances.
 */
public final class CommandSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public CommandSeq(int initialMaximum) {
        super(Command.class, initialMaximum);
    }


    public CommandSeq(Collection elements) {
        super(Command.class, elements);
    }
    ...
    public Object copy_from(Object src) {
        ...
        for(int i = 0; (i < origSize) && (i < srcSize); i++){
            if (typedSrc.get(i) == null){
                ...
                if (get(i) == null){ 
                    set(i, Command.create());
                }
                set(i, ((Copyable) get(i)).copy_from(typedSrc.get(i)));
            }
        }
        
        // copy 'new' Command objects (beyond the original size of this object)
