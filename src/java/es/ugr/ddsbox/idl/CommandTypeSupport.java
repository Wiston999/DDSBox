 ...
 * Command.
 */
public class CommandTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "Command";
    ...
    private static final CommandTypeSupport _singleton
        = new CommandTypeSupport();
     ...
     */
    public static CommandTypeSupport get_instance() {
        return _singleton;
    }

    public static CommandTypeSupport getInstance() {
        return get_instance();
    }
     ...
     * <code>this</code> is not a <code>Command</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        Command typedDst = (Command) destination;
        Command typedSrc = (Command) source;
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        Command typedSrc = (Command) sample;
...
Command typedDst = (Command) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
Command typedDst = (Command) sample;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new CommandDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new CommandDataReader(native_reader, listener, mask, this);                
    ...
    protected CommandTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,CommandTypeCode.VALUE,Command.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected CommandTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,CommandTypeCode.VALUE,Command.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
