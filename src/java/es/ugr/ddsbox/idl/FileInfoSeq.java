 ...
 */
public final class FileInfoSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public FileInfoSeq(int initialMaximum) {
        super(FileInfo.class, initialMaximum);
    }


    public FileInfoSeq(Collection elements) {
        super(FileInfo.class, elements);
    }
    ...
    public Object copy_from(Object src) {
        ...
        for(int i = 0; (i < origSize) && (i < srcSize); i++){
            if (typedSrc.get(i) == null){
                ...
                if (get(i) == null){ 
                    set(i, FileInfo.create());
                }
                set(i, ((Copyable) get(i)).copy_from(typedSrc.get(i)));
            }
        }
        
        // copy 'new' FileInfo objects (beyond the original size of this object)
