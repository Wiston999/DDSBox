 ...
 * FileInfo.
 */
public class FileInfoTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "FileInfo";
    ...
    private static final FileInfoTypeSupport _singleton
        = new FileInfoTypeSupport();
     ...
     */
    public static FileInfoTypeSupport get_instance() {
        return _singleton;
    }

    public static FileInfoTypeSupport getInstance() {
        return get_instance();
    }
     ...
     * <code>this</code> is not a <code>FileInfo</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        FileInfo typedDst = (FileInfo) destination;
        FileInfo typedSrc = (FileInfo) source;
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        FileInfo typedSrc = (FileInfo) sample;
        ...
        currentAlignment += CdrPrimitiveType.getStringSerializedSize(currentAlignment, typedSrc.fileName);
            
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
            
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
            
        currentAlignment += CdrPrimitiveType.getStringSerializedSize(currentAlignment, typedSrc.hash);
...
FileInfo typedSrc = (FileInfo) src;    
        ...
        dst.writeString(typedSrc.fileName,((es.ugr.ddsbox.idl.MAX_NAME.VALUE)));
            
        dst.writeInt(typedSrc.timestamp);        
            
        dst.writeInt(typedSrc.size);        
            
        dst.writeString(typedSrc.hash,((es.ugr.ddsbox.idl.MAX_NAME.VALUE)));
            
        dst.writeBoolean(typedSrc.isDir);        
            
        dst.writeShort(typedSrc.change);        
...
FileInfo typedDst = (FileInfo) dst;
    ...
    try {
            ...
            typedDst.fileName = src.readString(((es.ugr.ddsbox.idl.MAX_NAME.VALUE)));
            
            typedDst.timestamp = src.readInt();
            
            typedDst.size = src.readInt();
            
            typedDst.hash = src.readString(((es.ugr.ddsbox.idl.MAX_NAME.VALUE)));
            
            typedDst.isDir = src.readBoolean();
            
            typedDst.change = src.readShort();
...
FileInfo typedDst = (FileInfo) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
FileInfo typedDst = (FileInfo) sample;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new FileInfoDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new FileInfoDataReader(native_reader, listener, mask, this);                
    ...
    protected FileInfoTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,FileInfoTypeCode.VALUE,FileInfo.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected FileInfoTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,FileInfoTypeCode.VALUE,FileInfo.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
