...
/**
 * A sequence of FileSegment instances.
 */
public final class FileSegmentSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public FileSegmentSeq() {
        super(FileSegment.class);
    }


    public FileSegmentSeq(int initialMaximum) {
        super(FileSegment.class, initialMaximum);
    }


    public FileSegmentSeq(Collection elements) {
        super(FileSegment.class, elements);
    }
