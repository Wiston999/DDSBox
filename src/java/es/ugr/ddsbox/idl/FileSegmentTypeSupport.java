 ...
 * FileSegment.
 */
public class FileSegmentTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "FileSegment";
    ...
    private static final FileSegmentTypeSupport _singleton
        = new FileSegmentTypeSupport();
     ...
     */
    public static FileSegmentTypeSupport get_instance() {
        return _singleton;
    }

    public static FileSegmentTypeSupport getInstance() {
        return get_instance();
    }
     ...
     * <code>this</code> is not a <code>FileSegment</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        FileSegment typedDst = (FileSegment) destination;
        FileSegment typedSrc = (FileSegment) source;
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        FileSegment typedSrc = (FileSegment) sample;
        ...
        currentAlignment += CdrPrimitiveType.BYTE.getSequenceSerializedSize(currentAlignment, typedSrc.segmentContent);
...
FileSegment typedSrc = (FileSegment) src;    
        ...
        dst.writeInt(typedSrc.idSegment);        
            
        dst.writeByteSeq(typedSrc.segmentContent,((es.ugr.ddsbox.idl.MAX_PAYLOAD_SIZE.VALUE)));
...
FileSegment typedDst = (FileSegment) dst;
    ...
    try {
            ...
            typedDst.idSegment = src.readInt();
            
            src.readByteSequence(typedDst.segmentContent);
...
FileSegment typedDst = (FileSegment) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
FileSegment typedDst = (FileSegment) sample;
    ...
    public void key_to_instance(Object endpoint_data,
                                Object instance,
                                Object key) {
        FileSegment typedDst
            = (FileSegment) instance;
        FileSegment typedSrc
            = (FileSegment) key;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new FileSegmentDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new FileSegmentDataReader(native_reader, listener, mask, this);                
    ...
    protected FileSegmentTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, true,FileSegmentTypeCode.VALUE,FileSegment.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected FileSegmentTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,FileSegmentTypeCode.VALUE,FileSegment.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
