...
/**
 * A sequence of FolderInfo instances.
 */
public final class FolderInfoSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public FolderInfoSeq() {
        super(FolderInfo.class);
    }


    public FolderInfoSeq(int initialMaximum) {
        super(FolderInfo.class, initialMaximum);
    }


    public FolderInfoSeq(Collection elements) {
        super(FolderInfo.class, elements);
    }
