 ...
 * FolderInfo.
 */
public class FolderInfoTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "FolderInfo";
    ...
    private static final FolderInfoTypeSupport _singleton
        = new FolderInfoTypeSupport();
     ...
     */
    public static FolderInfoTypeSupport get_instance() {
        return _singleton;
    }

    public static FolderInfoTypeSupport getInstance() {
        return get_instance();
    }
     ...
     * <code>this</code> is not a <code>FolderInfo</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        FolderInfo typedDst = (FolderInfo) destination;
        FolderInfo typedSrc = (FolderInfo) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  CdrPrimitiveType.BYTE.getSequenceMaxSizeSerialized(currentAlignment, ((es.ugr.ddsbox.idl.MAX_PAYLOAD_SIZE.VALUE)));
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        FolderInfo typedSrc = (FolderInfo) sample;
        ...
        currentAlignment += CdrPrimitiveType.getStringSerializedSize(currentAlignment, typedSrc.userUuid);
            
        currentAlignment += CdrPrimitiveType.getStringSerializedSize(currentAlignment, typedSrc.destUser);
            
        currentAlignment += CdrPrimitiveType.getStringSerializedSize(currentAlignment, typedSrc.owner);
            
        currentAlignment += CdrPrimitiveType.getStringSerializedSize(currentAlignment, typedSrc.uuid);
            
        currentAlignment += CdrPrimitiveType.getStringSerializedSize(currentAlignment, typedSrc.folderName);
            
        currentAlignment += CdrPrimitiveType.SHORT.getMaxSizeSerialized(currentAlignment);
            
        currentAlignment += CdrPrimitiveType.SHORT.getMaxSizeSerialized(currentAlignment);
            
        currentAlignment += CdrPrimitiveType.BYTE.getSequenceSerializedSize(currentAlignment, typedSrc.encryptedKey);
            
        currentAlignment += CdrPrimitiveType.BYTE.getSequenceSerializedSize(currentAlignment, typedSrc.content);
...
FolderInfo typedSrc = (FolderInfo) src;    
        ...
        dst.writeString(typedSrc.userUuid,((es.ugr.ddsbox.idl.MAX_NAME.VALUE)));
            
        dst.writeString(typedSrc.destUser,((es.ugr.ddsbox.idl.MAX_NAME.VALUE)));
            
        dst.writeString(typedSrc.owner,((es.ugr.ddsbox.idl.MAX_NAME.VALUE)));
            
        dst.writeString(typedSrc.uuid,((es.ugr.ddsbox.idl.MAX_NAME.VALUE)));
            
        dst.writeString(typedSrc.folderName,((es.ugr.ddsbox.idl.MAX_NAME.VALUE)));
            
        dst.writeShort(typedSrc.type);        
            
        dst.writeShort(typedSrc.permission);        
            
        dst.writeByteSeq(typedSrc.encryptedKey,((es.ugr.ddsbox.idl.MAX_PAYLOAD_SIZE.VALUE)));
            
        dst.writeByteSeq(typedSrc.content,((es.ugr.ddsbox.idl.MAX_PAYLOAD_SIZE.VALUE)));
...
FolderInfo typedDst = (FolderInfo) dst;

    try {

            typedDst.userUuid = src.readString(((es.ugr.ddsbox.idl.MAX_NAME.VALUE)));
            
            typedDst.destUser = src.readString(((es.ugr.ddsbox.idl.MAX_NAME.VALUE)));
            
            typedDst.owner = src.readString(((es.ugr.ddsbox.idl.MAX_NAME.VALUE)));
            
            typedDst.uuid = src.readString(((es.ugr.ddsbox.idl.MAX_NAME.VALUE)));
            
            typedDst.folderName = src.readString(((es.ugr.ddsbox.idl.MAX_NAME.VALUE)));
            
            typedDst.type = src.readShort();
            
            typedDst.permission = src.readShort();
            
            src.readByteSequence(typedDst.encryptedKey);
            
            src.readByteSequence(typedDst.content);
...
FolderInfo typedDst = (FolderInfo) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
FolderInfo typedDst = (FolderInfo) sample;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new FolderInfoDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new FolderInfoDataReader(native_reader, listener, mask, this);                
    ...
    protected FolderInfoTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,FolderInfoTypeCode.VALUE,FolderInfo.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected FolderInfoTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,FolderInfoTypeCode.VALUE,FolderInfo.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
