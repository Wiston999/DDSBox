...
/**
 * A sequence of GlobalMessage instances.
 */
public final class GlobalMessageSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public GlobalMessageSeq() {
        super(GlobalMessage.class);
    }


    public GlobalMessageSeq(int initialMaximum) {
        super(GlobalMessage.class, initialMaximum);
    }


    public GlobalMessageSeq(Collection elements) {
        super(GlobalMessage.class, elements);
    }
