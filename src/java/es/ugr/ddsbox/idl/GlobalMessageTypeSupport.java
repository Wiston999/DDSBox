 ...
 * GlobalMessage.
 */
public class GlobalMessageTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "GlobalMessage";
    ...
    private static final GlobalMessageTypeSupport _singleton
        = new GlobalMessageTypeSupport();
     ...
     */
    public static GlobalMessageTypeSupport get_instance() {
        return _singleton;
    }

    public static GlobalMessageTypeSupport getInstance() {
        return get_instance();
    }
     ...
     * <code>this</code> is not a <code>GlobalMessage</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        GlobalMessage typedDst = (GlobalMessage) destination;
        GlobalMessage typedSrc = (GlobalMessage) source;
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        GlobalMessage typedSrc = (GlobalMessage) sample;
...
GlobalMessage typedDst = (GlobalMessage) dst;
...
GlobalMessage typedDst = (GlobalMessage) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
GlobalMessage typedDst = (GlobalMessage) sample;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new GlobalMessageDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new GlobalMessageDataReader(native_reader, listener, mask, this);                
    ...
    protected GlobalMessageTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,GlobalMessageTypeCode.VALUE,GlobalMessage.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected GlobalMessageTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,GlobalMessageTypeCode.VALUE,GlobalMessage.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
