...
/**
 * A writer for the User user type.
 */
public class UserDataWriter extends DataWriterImpl {
    // -----------------------------------------------------------------------
    // Public Methods
    // -----------------------------------------------------------------------

    public InstanceHandle_t register_instance(User instance_data) {
        return register_instance_untyped(instance_data);
    }
    
    
    public InstanceHandle_t register_instance_w_timestamp(User instance_data,
    ...
    public InstanceHandle_t register_instance_w_params(User instance_data,
    ...
    public void unregister_instance(User instance_data,
                                     InstanceHandle_t handle) {
        unregister_instance_untyped(instance_data, handle);
    }
    
    
    public void unregister_instance_w_timestamp(User instance_data,
    ...
    public void unregister_instance_w_params(User instance_data,
                                             WriteParams_t params) {
    ...
    public void write(User instance_data, InstanceHandle_t handle) {
        write_untyped(instance_data, handle);
    }
    
    
    public void write_w_timestamp(User instance_data,
            InstanceHandle_t handle, Time_t source_timestamp) {
    ...
    public void write_w_params(User instance_data,
                               WriteParams_t params) {
    ...
    public void dispose(User instance_data, InstanceHandle_t instance_handle){
        dispose_untyped(instance_data, instance_handle);
    }
    
    
    public void dispose_w_timestamp(User instance_data,
    ...
    public void dispose_w_params(User instance_data,
                                 WriteParams_t params) {
    ...
    /*package*/ UserDataWriter(long native_writer, DataWriterListener listener,
