...
/**
 * A sequence of UserMessage instances.
 */
public final class UserMessageSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public UserMessageSeq() {
        super(UserMessage.class);
    }


    public UserMessageSeq(int initialMaximum) {
        super(UserMessage.class, initialMaximum);
    }


    public UserMessageSeq(Collection elements) {
        super(UserMessage.class, elements);
    }
