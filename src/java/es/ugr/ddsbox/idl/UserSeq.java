 ...
 */
public final class UserSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public UserSeq(int initialMaximum) {
        super(User.class, initialMaximum);
    }


    public UserSeq(Collection elements) {
        super(User.class, elements);
    }
    ...
    public Object copy_from(Object src) {
        ...
        // copy 'new' User objects (beyond the original size of this object)
