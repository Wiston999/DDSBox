 ...
 * User.
 */
public class UserTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------
    ...
    private static final UserTypeSupport _singleton
        = new UserTypeSupport();
     ...
     */
    public static UserTypeSupport get_instance() {
        return _singleton;
    }

    public static UserTypeSupport getInstance() {
        return get_instance();
    }
     ...
     * <code>this</code> is not a <code>User</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        User typedDst = (User) destination;
        User typedSrc = (User) source;
	...
	Object sample) 
    {
        ...
        currentAlignment += CdrPrimitiveType.getStringSerializedSize(currentAlignment, typedSrc.realName);
            
        currentAlignment += CdrPrimitiveType.getStringSerializedSize(currentAlignment, typedSrc.email);
            
        currentAlignment += CdrPrimitiveType.getStringSerializedSize(currentAlignment, typedSrc.publicRSA);
...
User typedSrc = (User) src;    
        ...
        dst.writeString(typedSrc.realName,((es.ugr.ddsbox.idl.MAX_NAME.VALUE)));
            
        dst.writeString(typedSrc.email,((es.ugr.ddsbox.idl.MAX_NAME.VALUE)));
            
        dst.writeString(typedSrc.publicRSA,((es.ugr.ddsbox.idl.MAX_PARAMETER.VALUE)));
            
        dst.writeShort(typedSrc.online);        
...
User typedDst = (User) dst;
    ...
    try {
            ...
            typedDst.realName = src.readString(((es.ugr.ddsbox.idl.MAX_NAME.VALUE)));
            
            typedDst.email = src.readString(((es.ugr.ddsbox.idl.MAX_NAME.VALUE)));
            
            typedDst.publicRSA = src.readString(((es.ugr.ddsbox.idl.MAX_PARAMETER.VALUE)));
            
            typedDst.online = src.readShort();
...
User typedDst = (User) sample;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new UserDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new UserDataReader(native_reader, listener, mask, this);                
    ...
    protected UserTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,UserTypeCode.VALUE,User.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected UserTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,UserTypeCode.VALUE,User.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
