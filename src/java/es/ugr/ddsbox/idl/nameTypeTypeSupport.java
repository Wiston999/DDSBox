 ...
 * nameType.
 */
public class nameTypeTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "nameType";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};

    

    private static final nameTypeTypeSupport _singleton
        = new nameTypeTypeSupport();
     ...
     */
    public static nameTypeTypeSupport get_instance() {
        return _singleton;
    }

    public static nameTypeTypeSupport getInstance() {
        return get_instance();
    }
     ...
     * <code>this</code> is not a <code>nameType</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        nameType typedDst = (nameType) destination;
        nameType typedSrc = (nameType) source;
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        nameType typedSrc = (nameType) sample;
...
nameType typedSrc = (nameType) src;    
        ...
        dst.writeString(typedSrc.userData,((es.ugr.ddsbox.idl.MAX_NAME.VALUE)));
...
nameType typedDst = (nameType) dst;

            typedDst.userData = src.readString(((es.ugr.ddsbox.idl.MAX_NAME.VALUE)));
...
nameType typedDst = (nameType) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
nameType typedDst = (nameType) sample;
    ...
    protected nameTypeTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,nameTypeTypeCode.VALUE,nameType.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected nameTypeTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,nameTypeTypeCode.VALUE,nameType.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
