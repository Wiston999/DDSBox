 ...
 * parameterType.
 */
public class parameterTypeTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "parameterType";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};

    

    private static final parameterTypeTypeSupport _singleton
        = new parameterTypeTypeSupport();
     ...
     */
    public static parameterTypeTypeSupport get_instance() {
        return _singleton;
    }

    public static parameterTypeTypeSupport getInstance() {
        return get_instance();
    }
     ...
     * <code>this</code> is not a <code>parameterType</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        parameterType typedDst = (parameterType) destination;
        parameterType typedSrc = (parameterType) source;
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        parameterType typedSrc = (parameterType) sample;
...
parameterType typedSrc = (parameterType) src;    
        ...
        dst.writeString(typedSrc.userData,((es.ugr.ddsbox.idl.MAX_PARAMETER.VALUE)));
...
parameterType typedDst = (parameterType) dst;

            typedDst.userData = src.readString(((es.ugr.ddsbox.idl.MAX_PARAMETER.VALUE)));
...
parameterType typedDst = (parameterType) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
parameterType typedDst = (parameterType) sample;
    ...
    protected parameterTypeTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,parameterTypeTypeCode.VALUE,parameterType.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected parameterTypeTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,parameterTypeTypeCode.VALUE,parameterType.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
